      ...
      <div className="row">
        <div className="col">
          <div className="border-end" style={{ marginTop: "220px" }}>
            ...
            >
              Ideas, stories, and knowledge are all creations that can be shaped
              by your own hands.
            </p>
          </div>
        </div>
        <div className="col">
          <div
            className="card"
            style={{ marginTop: "80px", border: "none", width: "525px" }}
          >
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <p
                  style={{ marginTop: "16px", color: "gray", fontSize: "13px" }}
                >
